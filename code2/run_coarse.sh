...
java -cp assign_parsing.jar:assign_parsing-submit.jar -server -mx2000m $PARSER_TESTER_PATH  -path $DATA_PATH -parserType COARSE_TO_FINE  -maxTrainLength 15 -maxTestLength 15 -threshold 0.01
